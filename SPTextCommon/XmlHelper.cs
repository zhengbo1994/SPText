...
namespace SPTextCommon
{
    public class XmlHelper
    {
        ...
        /// <param name="xmlData">存储序列化数据</param>
        public static void SetFile(string xmlPath, string xmlData)
        {
            StreamWriter writer;
        ...
        public static string GetFile(string xmlPath)
        {
