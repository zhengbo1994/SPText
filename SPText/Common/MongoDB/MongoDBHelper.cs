...
namespace SPText.Common.MongoDB
{
    ...
    //{
    //    public static readonly string connectionString_Default = System.Configuration.ConfigurationManager.AppSettings["ConnectionString_mongoDB"];// mongodb://192.168.0.220:27017/effmaster
    ...
    //    {
    //        return InsertOne<T>(connectionString_Default, database_Default, collectionName, entity);
    //    }
    //    public static SafeModeResult InsertOne<T>(string connectionString, string databaseName, string collectionName, T entity)
    //    {
    //        SafeModeResult result = null;//new SafeModeResult();
    //        if (null == entity)
    //        {
    //            return null;
    //        }
    ...
    //    #endregion
    //    #region 修改
    //    public static SafeModeResult Save<T>(string collectionName, T entity)
    //    {
    //        return MongoDBHelper.Save<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, entity);
    //    }
    //    public static SafeModeResult Save<T>(string connectionString, string databaseName, string collectionName, T entity)
    //    {
    //        MongoServer server = MongoServer.Create(connectionString);
    //        //获取数据库或者创建数据库（不存在的话）。
    //        MongoDatabase database = server.GetDatabase(databaseName);
    ...
    //    /// <returns></returns>
    //    public static SafeModeResult UpdateOne<T>(string collectionName, IMongoQuery query, IMongoUpdate update)
    //    {
    //        return MongoDBHelper.UpdateOne<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, query, update);
    //    }
    //    /// <summary>
    //    ///
    //    /// </summary>
    ...
    //    /// <param name="update">更新设置。调用示例：Update.Set("Title", "yanc") 或者 Update.Set("Title", "yanc").Set("Author", "yanc2") 等等</param>
    //    /// <returns></returns>
    //    public static SafeModeResult UpdateOne<T>(string connectionString, string databaseName, string collectionName, IMongoQuery query, IMongoUpdate update)
    //    {
    //        SafeModeResult result;
    ...
    //        {
    //            MongoCollection<BsonDocument> myCollection = database.GetCollection<BsonDocument>(collectionName);
    //            result = myCollection.Update(query, update, UpdateFlags.None);
    //        }
    //        return result;
    //    }
    ...
    //        var page = 1;
    //        var pageSize = count;
    //        return MongoDBHelper.GetAll<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, query, page, pageSize, sortBy, fields);
    //    }
    //    /// <summary>
    //    ///
    //    /// </summary>
    ...
    //    /// <returns></returns>
    //    public static List<T> GetAll<T>(string collectionName, IMongoQuery query, int page, int pageSize)
    //    {
    //        return MongoDBHelper.GetAll<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, query, page, pageSize, null);
    //    }
    //    /// <summary>
    //    ///
    //    /// </summary>
    ...
    //    /// <param name="sortBy">排序用的。调用示例：SortBy.Descending("Title") 或者 SortBy.Descending("Title").Ascending("Author")等等</param>
    //    /// <returns></returns>
    //    public static List<T> GetAll<T>(string collectionName, IMongoQuery query, int page, int pageSize, IMongoSortBy sortBy)
    //    {
    //        return MongoDBHelper.GetAll<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, query, page, pageSize, sortBy);
    //    }
    //    /// <summary>
    //    ///
    //    /// </summary>
    ...
    //    /// <param name="fields">只返回所需要的字段的数据。调用示例："Title" 或者 new string[] { "Title", "Author" }等等</param>
    //    /// <returns></returns>
    //    public static List<T> GetAll<T>(string collectionName, IMongoQuery query, int page, int pageSize, params string[] fields)
    //    {
    //        return MongoDBHelper.GetAll<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, query, page, pageSize, null, fields);
    //    }
    //    /// <summary>
    //    ///
    //    /// </summary>
    ...
    //    /// <param name="fields">只返回所需要的字段的数据。调用示例："Title" 或者 new string[] { "Title", "Author" }等等</param>
    //    /// <returns></returns>
    //    public static List<T> GetAll<T>(string collectionName, IMongoQuery query, int page, int pageSize, IMongoSortBy sortBy, params string[] fields)
    //    {
    //        return MongoDBHelper.GetAll<T>(MongoDBHelper.connectionString_Default, MongoDBHelper.database_Default, collectionName, query, page, pageSize, sortBy, fields);
    //    }
    //    /// <summary>
    ...
    //    /// <param name="fields">只返回所需要的字段的数据。调用示例："Title" 或者 new string[] { "Title", "Author" }等等</param>
    //    /// <returns></returns>
    //    public static List<T> GetAll<T>(string connectionString, string databaseName, string collectionName, IMongoQuery query, int page, int pageSize, IMongoSortBy sortBy, params string[] fields)
    //    {
    //        MongoServer server = MongoServer.Create(connectionString);
    //        //获取数据库或者创建数据库（不存在的话）。
    //        MongoDatabase database = server.GetDatabase(databaseName);
    ...
    //            }
    //            foreach (T entity in myCursor.SetSkip((page - 1) * pageSize).SetLimit(pageSize))//.SetSkip(100).SetLimit(10)是指读取第一百条后的10条数据。
    //            {
    //                result.Add(entity);
    //            }
    //        }
