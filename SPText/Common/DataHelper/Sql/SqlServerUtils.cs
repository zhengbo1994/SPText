...
namespace SPText.Common.DataHelper.Sql
{
    ...
    /// SqlHelper操作类
    /// </summary>
    public sealed partial class SqlServerUtils
    {
        /// <summary>
        /// 批量操作每批次记录数
        /// </summary>
        public static int sqlBatchSize = 2000;

        /// <summary>
        /// 超时时间
        /// </summary>
        public static int sqlCommandTimeOut = 600;
        ...
        public static void BatchUpdate(string connectionString, DataTable table)
        {
            ...
            try
            {
                ...
                //设置批量更新的每次处理条数
                adapter.UpdateBatchSize = sqlBatchSize;
                //设置事物
