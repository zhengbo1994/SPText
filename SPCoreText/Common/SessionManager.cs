...
namespace SPCoreText.Common
{
    public class SessionManager : IDisposable
    {
        ...
        {
            _httpContextAccessor.HttpContext.Session.Set(key, ConvertUtils.StringToBytesByUtf8(JsonSerializer.Serialize(data)));
        }
        ...
        public T GetSession<T>(string key) where T : class, new()
        {
            ...
            {
                t = JsonSerializer.Deserialize<T>(ConvertUtils.BytesToStringByUtf8(sessionObjJson));
            }
            return t;
        }
