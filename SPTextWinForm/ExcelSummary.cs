...
namespace ExcelSummarySheet
{
    public partial class ExcelSummary : Form
    {
        ...
        public static void ExcelToDataTable1(string opnFileName, string dbName, ref DataSet ds, string dstablename)
        {
        ...
        public static void ExcelToDataTable2(string opnFileName, string dbName, ref DataSet ds, string dstablename, ref OleDbDataAdapter oleDbDataAdapter)
        {
            #region  读取Excel模板-POI
            string ExFname = opnFileName;
            OleDbConnection OleDbConnNew = ClsDB.ConnExcel(ExFname);
